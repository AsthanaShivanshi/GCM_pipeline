...
cdf_path = "CDFT/ensemble_median_pr_day_rcp26.nc"
dotc_path = "dOTC/ensemble_median_pr_day_rcp26.nc"
eqm_path = "EQM/ensemble_median_pr_day_rcp26.nc"
...
cdf_interp_path = "CDFT/ensemble_median_pr_day_rcp26_bicubic.nc"
dotc_interp_path = "dOTC/ensemble_median_pr_day_rcp26_bicubic.nc"
eqm_interp_path = "EQM/ensemble_median_pr_day_rcp26_bicubic.nc"
...
ax.set_title("BC+ Bicubically Interpolated RCP26 Ensemble Median; 2011-2023 for Precipitation", fontsize=22, fontweight='bold')
plt.savefig("../outputs/gridwise_pss_winner_pr_climatology_rcp26_bicubic.png", dpi=1000, bbox_inches='tight')
plt.close()