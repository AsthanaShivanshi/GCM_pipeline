#!/bin/bash
#SBATCH --job-name=detrending_taspr_CDFT_rcp26
#SBATCH --output=logs/detrending_taspr_CDFT_rcp26_job_output-%j.txt
#SBATCH --error=logs/detrending_taspr_CDFT_rcp26_job_error-%j.txt
#SBATCH --ntasks=1
...
OUT_DIR="/work/FAC/FGSE/IDYST/tbeucler/downscaling/sasthana/Downscaling/GCM_pipeline/EUROCORDEX_11_RCP2.6_BC_detrended/CDFT/"
