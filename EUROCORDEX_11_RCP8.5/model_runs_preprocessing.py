...
TEMP_INPUT_DIR = f"{config.MODELS_RUNS_EUROCORDEX_11_RCP85}/pr"
TEMP_OUTPUT_DIR = f"{config.BASE_DIR}/sasthana/Downscaling/GCM_pipeline/EUROCORDEX_11_RCP8.5/pr_Swiss"
