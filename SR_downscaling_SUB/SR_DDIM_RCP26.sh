#!/bin/bash
#SBATCH --job-name=CDFT_dOTC_DDIM_SR_RCP26_BC_allcells
#SBATCH --output=logs/SR_SUB/CDFT_dOTC_DDIM_SR_RCP26_BC_AllCells_output-%A_%a.txt
#SBATCH --error=logs/SR_SUB/CDFT_dOTC_DDIM_SR_RCP26_BC_AllCells_job_error-%A_%a.txt
#SBATCH --ntasks=1
...
for ENSEMBLE in EQM dOTC CDFT ; do
    ...
    python SR_downscaling_SUB/inference_allframes_eta0_RCP26.py --start_year $START_YEAR --end_year $END_YEAR --mode $MODE --ensemble $ENSEMBLE
