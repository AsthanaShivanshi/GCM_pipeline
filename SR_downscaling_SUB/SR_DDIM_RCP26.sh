...
#SBATCH --output=logs/SR_SUB/CDFT_DDIM_SR_RCP26_BC_AllCells_output-%A_%a.txt
#SBATCH --error=logs/SR_SUB/CDFT_DDIM_SR_RCP26_BC_AllCells_job_error-%A_%a.txt
#SBATCH --ntasks=1
