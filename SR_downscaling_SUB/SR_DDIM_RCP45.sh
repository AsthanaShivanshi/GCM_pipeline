#!/bin/bash
#SBATCH --job-name=dOTC_RCP45_DDIM_SR_BC_allcells
#SBATCH --output=logs/SR_SUB/dOTC_RCP45_DDIM_SR_BC_AllCells_output-%A_%a.txt
#SBATCH --error=logs/SR_SUB/dOTC_RCP45_DDIM_SR_BC_AllCells_job_error-%A_%a.txt
#SBATCH --ntasks=1
