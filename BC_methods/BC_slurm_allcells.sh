#!/bin/bash
#SBATCH --job-name=dOTC_tas_pr_RCP4.5_BC_allcells
#SBATCH --output=logs/bc/dOTC/dOTC_tas_pr_RCP4.5_BC_AllCells_output-%j.txt
#SBATCH --error=logs/bc/dOTC/dOTC_tas_pr_RCP4.5_BC_AllCells_job_error-%j.txt
#SBATCH --ntasks=1
