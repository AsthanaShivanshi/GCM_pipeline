...
cdf_path = "CDFT/ensemble_median_tas_day_rcp85.nc"
dotc_path = "dOTC/ensemble_median_tas_day_rcp85.nc"
eqm_path = "EQM/ensemble_median_tas_day_rcp85.nc"
...
ax.set_title("Best PSS for Median Daily Temperature (RCP85 Ensemble Median;2011-2023)", fontsize=22, fontweight='bold')
plt.savefig("../outputs/gridwise_pss_winner_tas_climatology_rcp85.png", dpi=1000, bbox_inches='tight')
plt.close()