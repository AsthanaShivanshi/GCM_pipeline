...
#----------------------------------------------------------------------#
        ...
        for model_id in common_ids:
            ...
            out_path_unet = f"ALP-FINE_2.6/{args.ensemble}/UNet_RCP26_{args.start_year}-{args.end_year}_tas_{model_id}.nc"
...
#----------------------------------------------------------------------#
        ...
        for tas_path in tas_files:
            ...
            out_path_ddim = f"ALP-FINE_2.6/{args.ensemble}/DDIM_{num_samples}samples_RCP26_{args.start_year}-{args.end_year}_tas_{get_id(pr_path, 'pr')}"
