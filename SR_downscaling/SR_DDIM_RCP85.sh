#!/bin/bash
#SBATCH --job-name=EQM_DDIM_SR_RCP85_BC_allcells
#SBATCH --output=logs/SR/EQM_DDIM_SR_RCP85_BC_AllCells_output-%A_%a.txt
...
#SBATCH --gres=gpu:1
#SBATCH --array=32-118 ##yearly till 2099, 119 years in total.
