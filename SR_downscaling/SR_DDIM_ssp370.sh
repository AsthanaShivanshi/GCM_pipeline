#!/bin/bash
#SBATCH --job-name=DDIM_allcells
#SBATCH --output=logs/SR/DDIM_allcells_output-%A_%a.log
#SBATCH --error=logs/SR/DDIM_allcells_job_error-%A_%a.log
#SBATCH --ntasks=1
...
START_YEARS=(1981 1991 2001 2011 2015 2021 2031 2041 2051 2061 2071 2081 2091)
END_YEARS=( 1990 2000 2010 2014 2020 2030 2040 2050 2060 2070 2080 2090 2100)
